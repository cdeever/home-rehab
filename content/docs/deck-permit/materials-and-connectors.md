...
All fasteners in contact with PT lumber must be hot-dipped galvanized, stainless steel, or listed by the preservative manufacturer for the treatment used.

| Location | Fastener | Size |
|---|---|---|
| Ledger to rim joist | Through-bolt with washers | ½" dia. × length to suit |
| Joist hanger nails | HDG joist-hanger nails | 10d × 1½" |
| Beam ply to ply | Structural screws or nails | Per manufacturer (e.g., SDWS22500DB) |
| Deck boards to joists | HDG ring-shank or composite screws | Per board mfr. |
| Guardrail post to rim | ½" through-bolts + DTT2Z hold-down | Per R507.10 |

## Connectors (Simpson Strong-Tie or equivalent ICC-certified)

| Location | Connector | Model |
|---|---|---|
...
| Parameter | Value |
|---|---|
| Compressive strength | 3,000 psi @ 28 days |
| Mix | 5–6 bag, per ASTM C94 |
| Air entrainment | 5–7% (exterior exposure) |
