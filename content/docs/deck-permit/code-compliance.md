...
Design conforms to the 2018 International Residential Code (IRC) as adopted by the State of Ohio, and the Franklin County Deck Guide (referenced throughout).

## Loads (IRC Table R301.5)

| Load | Value | Notes |
|---|---|---|
| Live load (exterior balcony / deck) | 40 psf | |
| Dead load | 10 psf | |
| Snow load (ground, Columbus area) | 20 psf | Not additive to live |
| Guardrail — concentrated | 200 lbf | Applied at top rail |
| Guardrail — infill | 50 lbf over 1 sq ft | |

## Key IRC Sections Referenced

| Topic | IRC Section |
|---|---|
| Deck footings | R403 / R507.3 |
| Posts | R507.4 |
| Beams and joist spans | R507.5, R507.6 |
...
Per IRC R507.9.2, at least two tension ties (e.g., Simpson DTT2Z) connect the deck joists to interior floor framing through the house rim to resist lateral loads — detail per Franklin County Deck Guide.
...
## Gas Stub Decommissioning (Coordinating Scope — Separate Permit)

The current ledger has a notch for an exterior gas stub that has never been in service by the current owner (propane grill used throughout ownership). Under a separate Franklin County Public Health gas/mechanical permit, a licensed Ohio plumbing contractor (ORC § 4740) will shut off the upstream branch in the crawl space, cut the exterior stub, and cap the interior line so the new ledger can be installed continuous with no utility penetrations. Applicable 2018 IFGC sections:

| Topic | IFGC Section |
|---|---|
| Capping / plugging unused gas outlets and leak test | 406 |
